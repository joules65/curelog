    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 space-y-12">
        ...
        <section className="space-y-6">
          ...
          <div className="flex flex-col gap-6 xl:flex-row">
            <CustomFormField fieldType={FormFieldType.INPUT} control={form.control} name="address" label="Address" placeholder="No 13, Ebitu Ukiwe Street, Jabi" />
        ...
        <section className="space-y-6">
          ...
          <div className="flex flex-col gap-6 xl:flex-row">
            <CustomFormField fieldType={FormFieldType.INPUT} control={form.control} name="insuranceProvider" label="Insurance provider" placeholder="Leadway Health" />
          ...
          <div className="flex flex-col gap-6 xl:flex-row">
            ...
            <CustomFormField fieldType={FormFieldType.TEXTAREA} control={form.control} name="currentMedication" label="Current medications" placeholder="Emzor Paracetamol 200mg" />
          </div>
          <div className="flex flex-col gap-6 xl:flex-row">
            <CustomFormField
              ...
              placeholder="Grandmother had arthritis"
            />
            <CustomFormField
              fieldType={FormFieldType.TEXTAREA}
              control={form.control}
              ...
              placeholder="Attempted lobotomy with scissors"
            />
          </div>
        </section>
        <section className="space-y-6">
